...
const achievementData = [
  ...
  },
  {
    ...
    subtitle: "1st runner-up in interschool music competition,<br/> Finalist in interschool chess competition,<br/> First runner-up in extempore,<br/> Winner of cookery show",
    description:
